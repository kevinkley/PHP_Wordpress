...
    		</div>
		...
		<div id="title-single"><?php custom_breadcrumbs(); ?></div>
			...
			<div class="main-single">
				...
				<div id="imagem-thumbnail">
					...
					<div class="caixa-meta-inf">
						<div class="caixa-info">	
							...
							<!-- Episódio e Status     --><div class="episo-status"><h4>Episódios: <span><?php echo rwmb_meta('episodios-volumes'); ?></span></h4> <h2>Status:		<span><?php echo rwmb_meta('status'); ?>			</span></h2></div>
							<!-- Estudio  e Lançamento --><div class="estu-ano">    <h4>Estúdio:   <span><?php echo rwmb_meta('estudio');   		?></span></h4> <h2>Lançamento: 	<span><?php echo rwmb_meta('lançamento'); ?>		</span></h2></div>
							<!-- Audio    e Fansub     --><div class="audio-fans">  <h4>Áudio: 	   <span><?php echo rwmb_meta('audio');     		?></span></h4> <h2>Fansub:     	<span><?php echo rwmb_meta('fansub-scanlator'); ?>	</span></h2></div>
							<!-- Genero                --><div class="genero">      <h4>Gênero:    <span><?php echo rwmb_meta('tipo');      		?></span></h4></div>
						</div>	
				...
				<div class="class-episodio"><!-- Blu-ray, Formato e Tamanho -->
					...
					<h1>Episódios</h1><!-- Informações de Episódios e + -->					
						<div class="forma-tama"><h2>Blu-ray: <span><?php echo rwmb_meta('blu-ray');   ?></span></h2><h3>Tamanho: <span><?php echo rwmb_meta('tamanho'); ?></span></h3><h2>Formato: <span><?php echo rwmb_meta('formato');   ?></span></h2></div>
						<div class="servidor"><h2>Servidor: <span><?php echo rwmb_meta('servidor');   ?></span></h2></div>
				</div>
					
					<div class="Episodios_link">
						<?php the_content();  ?>
					</div>															
